...
| config | object | `{"applications":[{"directives":"Include @coraza.conf-recommended\nInclude @crs-setup.conf.example\nInclude /etc/coraza/before.conf\nInclude @owasp_crs/*.conf\nInclude /etc/coraza/after.conf\n","log_file":"/dev/stdout","log_format":"json","log_level":"error","name":"default-app","response_check":false,"transaction_ttl_ms":60000}],"bind":"0.0.0.0:9000","default_application":"default-app","log_file":"/dev/stdout","log_format":"json","log_level":"info"}` | Coraza SPOA configuration: https://github.com/corazawaf/coraza-spoa/blob/main/example/coraza-spoa.yaml |
